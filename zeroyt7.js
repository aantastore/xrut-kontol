	...
	key : {
       ...
       message: {
       	         orderMessage: {
       	                  ...
       	                  status: 1,
                             surface : 1,
       	                  message: `Xrutz Selfbot!`,
                             orderTitle: `Xrutz Selfbot!`,
                             sellerJid: '0@s.whatsapp.net' 
                           }
                         }
                       }
...
break
        case 'command':
               list = []
               listmenu = [`groupmenu`,`searchmenu`,`scriptmenu`,`stickermenu`,`islamimenu`,`ownermenu`,`bugmenu`,`tebakmenu`,`downloadmenu`,`infomenu`,`textmenu`,`imagemenu`,`stalkmenu`]
               listmenuu = [`Menu Group`,`Search Menu`,`Script Menu`,`Sticker Menu`,`Islami Menu`,`Owner Menu`,`Bug Menu`,`Tebak Menu`,`Download Menu`,`Info Menu`,`Text Menu`,`Image Menu`,`Stalk Menu`]
               nombor = 1
               startnum = 0
...
case 'test': 
replyWithFakeLink('*Xrutz-Bot Stay Active!*\n*Link grup Bot :* https://chat.whatsapp.com/BABvK9nnhhJLImFXJaoLg9')
break
...
costum(buffer, sticker, Verived, `Subscribe Channel Xrutz BOT!`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
reply('*Ini Nomor Owner Xrutz BOT*\nMau Chat? Utamakan Salam!')
break
             case 'fakeloc':
